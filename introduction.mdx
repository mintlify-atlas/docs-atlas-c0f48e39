...
| **macOS** | Intel-based Macs are supported |
...
- [**NI LabVIEW**](https://www.ni.com/download/ni-usrp-1.3/4711/en/) — LabVIEW instruments and RFNoC FPGA integration
- [**REDHAWK**](https://redhawksdr.org/) — Government and defense SDR framework
- [**Osmocom GSM**](https://osmocom.org) and [**OpenBTS**](http://openbts.org) — Open-source cellular infrastructure
- [**Amarisoft LTE**](https://www.amarisoft.com/) — Commercial LTE/5G NR base-station software
