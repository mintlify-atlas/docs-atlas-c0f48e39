...
description: "Combine multiple USRP devices into a single logical device for MIMO operation, synchronized streaming, and large-scale phased RF arrays."
---
...
| 1 | Slot B, Device 0 |
| 2 | Slot A, Device 1 |
| 3 | Slot B, Device 2 (B:0 is first in `B:0 A:0` spec) |
| 4 | Slot A, Device 2 |
