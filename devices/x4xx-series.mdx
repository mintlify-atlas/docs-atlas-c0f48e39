...
<CardGroup cols={3}>
  <Card title="X410" icon="microchip">
    **4 full-duplex channels** via two ZBX daughterboards. Up to 400 MHz analog bandwidth per channel. Frequency: 1 MHz – 8 GHz (tunable to 8 GHz). Requires UHD 4.1+.
  </Card>
